...
export const Hero: FC = (): ReactElement => {
  return (
    <section className="flex w-full min-h-2 items-center justify-center gap-x-56 px-16 bg-[#F1F3FF]">
      <div className="w-1/2">
        ...
        <button className="bg-[#020181] py-1 px-3 text-center text-white font-semibold rounded">
          Masuk
        </button>
      </div>
