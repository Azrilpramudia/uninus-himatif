...
export const SellingPoint: FC = (): ReactElement => {
  return (
    <section className="p-8">
      <h2 className="px-9 text-4xl font-bold mb-4 text-[#020181]">Program Kerja</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-9">
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-bold mb-2 text-[#020181]">Melakukan Penilaian Diri</h3>
          <p>
            Pahami kondisi mental Anda dengan menyelesaikan tes dan kuestioner yang mudah digunakan.
          </p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-bold mb-2 text-[#020181]">Mendapatkan Analisis AI</h3>
          <p>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-bold mb-2 text-[#020181]">Temukan Bantuan Professional</h3>
          <p>
            Temukan faskes dan psikolog terdekat yang sesuai dengan kebutuhan Anda dengan mudah.
          </p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h3 className="text-xl font-bold mb-2 text-[#020181]">Pelajari Lebih Dalam</h3>
